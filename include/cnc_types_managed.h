...
public:
	CncMachineConfig(CNC_MACHINE_CONFIG &d)
	{
		...
		spindleRampUpTime             = d.spindleRampUpTime;     
		proportionalRampUpTime        = d.proportionalRampUpTime;
		spindleNmax                   = d.spindleNmax;                   
		spindleNmin                   = d.spindleNmin;                   
		spindleUseRPMSensor           = d.spindleUseRPMSensor;    
		spindleShowRPM				  = d.spindleShowRPM;
	...
	void Set(CNC_MACHINE_CONFIG &d)
	{
		...
		d.spindleRampUpTime             = spindleRampUpTime;
		d.proportionalRampUpTime        = proportionalRampUpTime;
		d.spindleNmax                   = spindleNmax;
		d.spindleNmin					= spindleNmin;
		d.spindleUseRPMSensor           = spindleUseRPMSensor;
		d.spindleShowRPM				= spindleShowRPM;
